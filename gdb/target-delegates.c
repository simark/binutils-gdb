...
delegate_xfer_partial (struct target_ops *self, ptid_t arg1, enum target_object arg2, const char *arg3, gdb_byte *arg4, const gdb_byte *arg5, ULONGEST arg6, ULONGEST arg7, ULONGEST *arg8)
{
  self = self->beneath;
  return self->to_xfer_partial (self, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
}

static enum target_xfer_status
tdefault_xfer_partial (struct target_ops *self, ptid_t arg1, enum target_object arg2, const char *arg3, gdb_byte *arg4, const gdb_byte *arg5, ULONGEST arg6, ULONGEST arg7, ULONGEST *arg8)
{
  return TARGET_XFER_E_IO;
}

static enum target_xfer_status
debug_xfer_partial (struct target_ops *self, ptid_t arg1, enum target_object arg2, const char *arg3, gdb_byte *arg4, const gdb_byte *arg5, ULONGEST arg6, ULONGEST arg7, ULONGEST *arg8)
{
  enum target_xfer_status result;
  fprintf_unfiltered (gdb_stdlog, "-> %s->to_xfer_partial (...)\n", debug_target.to_shortname);
  result = debug_target.to_xfer_partial (&debug_target, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
  fprintf_unfiltered (gdb_stdlog, "<- %s->to_xfer_partial (", debug_target.to_shortname);
  target_debug_print_struct_target_ops_p (&debug_target);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_ptid_t (arg1);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_enum_target_object (arg2);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_const_char_p (arg3);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_gdb_byte_p (arg4);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_const_gdb_byte_p (arg5);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_ULONGEST (arg6);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_ULONGEST (arg7);
  fputs_unfiltered (", ", gdb_stdlog);
  target_debug_print_ULONGEST_p (arg8);
  fputs_unfiltered (") = ", gdb_stdlog);
