...
struct dummy_target : public target_ops
{
  ...
  void kill () override;
  void load (const char *arg0, CORE_ADDR arg1) override;
...
void
target_ops::load (const char *arg0, CORE_ADDR arg1)
{
  this->beneath ()->load (arg0, arg1);
}

void
dummy_target::load (const char *arg0, CORE_ADDR arg1)
{
  tcomplain ();
}

void
debug_target::load (const char *arg0, CORE_ADDR arg1)
{
