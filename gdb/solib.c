      ...
      if (*p == '.')
        {
          ...
          new_pathname = (char *) alloca (
            p - in_pathname + 1 + strlen (solib_symbols_extension) + 1);
...
_initialize_solib ()
{
  ...
  gdb::observers::inferior_execd
    .attach ([] (inferior *inf) { solib_create_inferior_hook (0); }, "solib");
