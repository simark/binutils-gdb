...
public:
				   ...
				   int deref_size) override
  {
    ...
    this->gdbarch = get_objfile_arch (this->per_objfile->objfile);
	...
	case DWARF_VALUE_STACK:
	  {
	    ...
	    gdbarch *objfile_gdbarch
	      = get_objfile_arch (c->per_objfile->objfile);
	...
	case DWARF_VALUE_STACK:
	  {
	    ...
	    gdbarch *objfile_gdbarch = get_objfile_arch (per_objfile->objfile);
