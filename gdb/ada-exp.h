...
{
public:
  explicit ada_others_component (operation_up &&op) : m_op (std::move (op)) {}
...
{
public:
  explicit ada_choices_component (operation_up &&op) : m_op (std::move (op)) {}
...
{
public:
  explicit ada_name_association (operation_up val) : m_val (std::move (val)) {}
