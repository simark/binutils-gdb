...
{
public:
  auto_or_unknown_language (enum language lang) : language_defn (lang)
  { /* Nothing.  */
  }
...
{
public:
  auto_language () : auto_or_unknown_language (language_auto)
  { /* Nothing.  */
  }
...
{
public:
  unknown_language () : auto_or_unknown_language (language_unknown)
  { /* Nothing.  */
  }
