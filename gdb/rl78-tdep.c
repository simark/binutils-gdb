...
struct rl78_gdbarch : public gdbarch_tdep
{
...
{
  rl78_gdbarch *tdep = (rl78_gdbarch *) gdbarch_tdep (gdbarch);
...
rl78_gdbarch_init (struct gdbarch_info info, struct gdbarch_list *arches)
{
  ...
  for (arches = gdbarch_list_lookup_by_info (arches, &info);
    ...
    {
      rl78_gdbarch *tdep = (rl78_gdbarch *) gdbarch_tdep (arches->gdbarch);
  ...
  /* None found, create a new architecture from the information
     provided.  */
  rl78_gdbarch *tdep = new rl78_gdbarch;
