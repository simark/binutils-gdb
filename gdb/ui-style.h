...
struct ui_file_style
{
  ...
  {
  public:
    color (basic_color c) : m_simple (true), m_value (c) {}
  ...
  {
    return (
      m_foreground == other.m_foreground && m_background == other.m_background
      && m_intensity == other.m_intensity && m_reverse == other.m_reverse);
  }
