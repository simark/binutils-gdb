...
#define DEF_MI_CMD_MI(NAME, MI_FUNC) DEF_MI_CMD_MI_1(NAME, MI_FUNC, NULL)
  ...
  DEF_MI_CMD_MI_1 ("add-user-defined-thread-group",
		   mi_cmd_add_user_defined_thread_group,
		   &mi_suppress_notification.thread_group),
  ...
  DEF_MI_CMD_MI_1 ("remove-user-defined-thread-group",
		   mi_cmd_remove_user_defined_thread_group,
		   &mi_suppress_notification.thread_group),
